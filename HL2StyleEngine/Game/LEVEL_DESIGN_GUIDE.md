...
- For the prototype slice, floors/walls/ceilings render GLB meshes but use box colliders for stable movement. Dynamic pickups and crates use high friction, zero restitution, and spawn just above the floor to reduce idle bouncing.